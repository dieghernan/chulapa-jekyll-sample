...
![image-left]({{ site.url }}{{ site.baseurl }}/images/image-alignment-150x150.jpg){: .float-left .mx-1} The rest of this paragraph is filler for the sake of seeing the text wrap around the 150×150 image, which is **left aligned**.
...
![image-right]({{ site.url }}{{ site.baseurl }}/images/image-alignment-300x200.jpg){: .float-right .mx-1}
...
<figure style="width: 150px" class="align-left float-left mx-1">
...
<figure style="width: 300px" class="text-right float-right mx-1">
